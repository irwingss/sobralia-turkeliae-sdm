...
# Generated: 2026-06-25T16:24:06.847Z
...
#
# pip install dplyr ENMeval maxnet sf terra

import sys, subprocess
_REQUIREMENTS = ["dplyr","ENMeval","maxnet","sf","terra"]
...
# ──── #1 · Ejecución · 2026-06-25T16:23:39.060Z ───────────────────────────────────
...
# ──── #2 · Ejecución · 2026-06-25T16:24:06.716Z ───────────────────────────────────
# Tuning de hiperparámetros de MaxEnt
# Propósito: Optimización de hiperparámetros de MaxEnt utilizando ENMeval con Feature Classes de baja/media complejidad y validación cruzada por bloques espaciales (Spatial Block CV) para seleccionar el modelo con el mejor delta AICc.
# runtime: modal:biostats-python
# duration_ms: 741
